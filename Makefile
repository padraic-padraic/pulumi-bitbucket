...
PROJECT          := github.com/padraic-padraic/pulumi-bitbucket
NODE_MODULE_NAME := @pulumiverse/bitbucket
TF_NAME          := bitbucket
...
TFGEN            := pulumi-tfgen-bitbucket
PROVIDER         := pulumi-resource-bitbucket
VERSION          := $(shell pulumictl get version)

TESTPARALLELISM  := 4

WORKING_DIR      := $(shell pwd)
PULUMI_REPO_PATHS:= github.com/padraic-padraic/terraform-provider-bitbucket=$(ROOT_DIR)/upstream
export
...
upstream/.git:
	...
	git clone  --depth 1 https://github.com/padraic-padraic/terraform-provider-bitbucket.git upstream
