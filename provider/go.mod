module github.com/padraic-padraic/pulumi-bitbucket/provider
...
require (
	...
	github.com/padraic-padraic/terraform-provider-bitbucket/v2 v2.3.6
...
require (
	...
	github.com/DrFaust92/bitbucket-go-client v0.8.0 // indirect
